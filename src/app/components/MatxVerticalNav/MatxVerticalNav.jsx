                    ...
                    <NavLink
                        ...
                        isActive={(match, location) => {
                            ...
                            if (
                                ...
                                (item.path.includes('pending') &&
                                    window.location.pathname.includes(
                                        'pending'
                                    )) ||
                                (item.path.includes('approved') &&
                                    window.location.pathname.includes(
                                        'approved'
                                    ))
                            ) {
                        ...
                        className={clsx({
                            'flex justify-between border-radius-8 compactNavItem whitespace-pre overflow-hidden': true,
                            [classes.navItem]: true,
                            [classes.compactNavItem]: mode === 'compact',
                        })}
                    >
